...
vegtables = ['cabbage', 'tomatoes', 'water cress', 'beets', 'eggplant', 'yam', 'zucchini', 'artichoke', 'bock choy', 'cherry tomatoes', 'spaghetti squash', 'sweet peas', 'sweet potato', 'radishes', 'snow peas', 'peppers', 'pickled onions', 'jicama', 'onions', 'olives', 'jalapenos', 'mushrooms', 'cauliflower', 'celery', 'cucumber', 'alfalfa', 'sprouts', 'asparagus', 'avocado', 'red onion', 'beets', 'broccoli', 'bean sprouts', 'brussel sprouts', 'corn', 'baby corn', 'carrots']
meat = ['bacon', 'tofu', 'beef', 'tuna', 'fish', 'salmon', 'steak', 'ham', 'chicken', 'sausage', 'turkey', 'shrimp', 'crab meat', 'salami', 'ham', 'anchovy']
...
carbs = ['crispy noodles', 'tortilla strips', 'croutons', 'bread','couscous', 'quinoa']
