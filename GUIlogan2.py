...
class Application(tk.Frame):
    ...
    def pressinfo(self):
        ...
        disc = tk.Label(top, text = infotext , font= fo)
        disc.grid()
    ...
    def display_recipe(self, want_to_cook):
        ...
        top.title("Recipe")
        top.resizable(0,0)
        rec = tk.Label(top, text = recipe_directions , font= fo)
    ...
    def allergy(self): 
        ingred = tk.StringVar()
        allerdescript = tk.Label(self.master, text="Enter allergens seperated by commas:", bg=c,fg=d, font= fo)
