...
spices = ['soy sauce', 'chili sauce', 'chili powder','white wine','red wine','brown sugar','curry','basil','rosemary','cumin','garlic','cinnamon','ginger','cloves','fennel','thyme','saffrom']
